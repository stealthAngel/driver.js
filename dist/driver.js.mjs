...
function Y(e, o) {
  ...
  const C = ((x = o.popover) == null ? void 0 : x.popoverClass) || s("popoverClass") || "";
  u.className = `driver-popover ${C}`.trim(), oe(
    t.wrapper,
    (k) => {
      var $, B, M;
      const T = k.target, E = (($ = o.popover) == null ? void 0 : $.onNextClick) || s("onNextClick"), A = ((B = o.popover) == null ? void 0 : B.onPrevClick) || s("onPrevClick"), H = ((M = o.popover) == null ? void 0 : M.onCloseClick) || s("onCloseClick");
...
function ne(e, o) {
  ...
  if (h === "top" && c ? S = f = w = !1 : h === "bottom" && w ? S = f = c = !1 : h === "left" && f ? S = c = w = !1 : h === "right" && S && (f = c = w = !1), h === "over") {
    ...
    const x = window.innerWidth / 2 - (r == null ? void 0 : r.realWidth) / 2, b = 10;
    t.wrapper.style.left = `${x}px`, t.wrapper.style.right = "auto", t.wrapper.style.bottom = `${b}px`, t.wrapper.style.top = "auto";
  } else if (f) {
    const x = Math.min(
      u,
    ...
    t.wrapper.style.left = `${x}px`, t.wrapper.style.top = `${b}px`, t.wrapper.style.bottom = "auto", t.wrapper.style.right = "auto", P = "left";
  } else if (S) {
    const x = Math.min(
      C,
      window.innerWidth - (r == null ? void 0 : r.realWidth) - v.width
    ...
    t.wrapper.style.top = `${x}px`, t.wrapper.style.left = `${b}px`, t.wrapper.style.bottom = "auto", t.wrapper.style.right = "auto", P = "top";
  } else if (w) {
    const x = Math.min(
      p,
    ...
    t.wrapper.style.left = `${b}px`, t.wrapper.style.bottom = `${x}px`, t.wrapper.style.top = "auto", t.wrapper.style.right = "auto", P = "bottom";
  }
...
function _e(e = {}) {
  ...
  function v(a = 0) {
    ...
    y("isNextStepCalled", !1), y("isPreviousStepCalled", !1), y("__activeOnDestroyed", document.activeElement), y("activeIndex", a);
    const p = c[a], w = c[a + 1], u = c[a - 1], f = ((A = p.popover) == null ? void 0 : A.doneBtnText) || s("doneBtnText") || "Done", C = s("allowClose"), S = typeof ((H = p.popover) == null ? void 0 : H.showProgress) != "undefined" ? ($ = p.popover) == null ? void 0 : $.showProgress : s("showProgress"), P = (((B = p.popover) == null ? void 0 : B.progressText) || s("progressText") || "{{current}} of {{total}}").replace("{{current}}", `${a + 1}`).replace("{{total}}", `${c.length}`), x = ((M = p.popover) == null ? void 0 : M.showButtons) || s("showButtons"), b = [
      ...
      "previous",
      ...C ? ["close"] : []
    ].filter((re) => !(x != null && x.length) || x.includes(re)), k = ((z = p.popover) == null ? void 0 : z.onNextClick) || s("onNextClick"), T = ((q = p.popover) == null ? void 0 : q.onPrevClick) || s("onPrevClick"), E = ((V = p.popover) == null ? void 0 : V.onCloseClick) || s("onCloseClick");
    X({
      ...p,
      popover: {
        showButtons: b,
